...
koristi točno objavljenu verziju aktivnog jezika, zatim zadani jezik sitea iz
`app.localization.locale` u `config/app.php`, engleski te naposljetku drugi
jezik na kojem postoji objavljena verzija stranice. Nacrt nikada nije jezični
fallback.
